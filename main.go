...
func main() {
	remoteAPIURL := "https://www.us.envu.com/labels-and-sds" // URL to fetch HTML content from
	localFilePath := "envu.html"                               // Path where HTML file will be stored
...
func extractPDFUrls(input string) []string {
	...
	// Regex to find URLs ending with .pdf
